...
public class BioSystem {
    ...
    public static void expGrad_popAndgRateDistbs(double input_alpha){
        ...
        String filename_alive = "FGTA-death-alpha="+String.format("%.6f", input_alpha)+"-alive-distb";
        String filename_dead = "FGTA-death-alpha="+String.format("%.6f", input_alpha)+"-dead-distb";
        String filename_gRate = "FGTA-death-alpha="+String.format("%.6f", input_alpha)+"-gRate-distb";
