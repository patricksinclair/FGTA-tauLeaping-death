...
public class BioSystem {
    ...
    public static void expGrad_popAndgRateDistbs(double input_alpha){
        ...
        String filename_alive = "FGTA-death-alpha="+String.format("%.6f", input_alpha)+"-alive-distb-RESEEDED";
        String filename_dead = "FGTA-death-alpha="+String.format("%.6f", input_alpha)+"-dead-distb-RESEEDED";
        String filename_gRate = "FGTA-death-alpha="+String.format("%.6f", input_alpha)+"-gRate-distb-RESEEDED";
